...
class TidePredictionCache(
    ...
    suspend fun savePredictions(item: TidePredictionRecord) =
        coroutineScope {
            try {
    ...
    suspend fun savePredictionsBatch(items: List<TidePredictionRecord>) =
        coroutineScope {
